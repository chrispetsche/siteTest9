        ...
        case "art":
            ...
            switch(skillPage)
            {
                case 1:
                    ...
                    document.getElementById("skillB-title").innerHTML = "Photoshop";
                    ...
                    document.getElementById("skillD-title").innerHTML = "3ds Max";
                    document.getElementById("skillD-percentage").innerHTML = "30%";
                    rootVariables.style.setProperty('--skill-value-D', '30%');

                    document.getElementById("skillE-title").innerHTML = "After Effects";
        ...
        case "dev":
            ...
            switch(skillPage)
            {
                case 1:
                    ...
                    document.getElementById("skillE-title").innerHTML = "Unity Engine";
